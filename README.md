# 📖 \*\*\[Documentation complète de la stratégie](./DOCS.md)\*\*
...
* **Proxy CORS public** : `corsproxy.io` et `allorigins.win` sont gratuits mais parfois rate-limités. Si ça plante en prod, soit :
  ...
  * Passer à une vraie API : [Polygon.io](https://polygon.io) (free tier 5 req/min), [Twelve Data](https://twelvedata.com), [Alpha Vantage](https://alphavantage.co), [Finnhub](https://finnhub.io). Stocker la clé API dans les **Environment Variables** de Render et l'utiliser dans le code via `import.meta.env.VITE\_API\_KEY`.
